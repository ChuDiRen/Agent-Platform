...
- **MUST run `gitnexus detect-changes --scope all` before committing** when MCP `gitnexus_detect_changes()` is unavailable, to verify your changes only affect expected symbols and execution flows.
